...
| 题目 | 训练点 |
|------|--------|
| [03 从尾到头打印链表](/ch09-offer/03) | 链表遍历与栈思想 |
| [14 链表中倒数第k个结点](/ch09-offer/14) | 双指针 |
| [15 反转链表](/ch09-offer/15) | 指针反转 |
| [16 合并两个排序的链表](/ch09-offer/16) | 有序链表操作 |
| [55 链表中环的入口结点](/ch09-offer/55) | 快慢指针 |
| [56 删除链表中重复的结点](/ch09-offer/56) | 边界结点处理 |
